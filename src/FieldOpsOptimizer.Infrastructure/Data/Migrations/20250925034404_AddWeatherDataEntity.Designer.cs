...
namespace FieldOpsOptimizer.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250925034404_AddWeatherDataEntity")]
    partial class AddWeatherDataEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FieldOpsOptimizer.Domain.Entities.WeatherData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsSuitableForFieldWork")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasComment("Whether weather conditions are suitable for field work");

                    b.Property<double>("PrecipitationAmount")
                        .HasPrecision(6, 2)
                        .HasColumnType("double precision")
                        .HasComment("Expected precipitation amount in mm");

                    b.Property<double>("PrecipitationChance")
                        .HasPrecision(5, 2)
                        .HasColumnType("double precision")
                    ...
                    b.Property<string>("WorkSafetyNotes")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                    ...
                    b.HasIndex("TenantId", "Condition", "Severity")
                        .HasDatabaseName("IX_WeatherData_Tenant_Condition_Severity");

                    b.HasIndex("TenantId", "IsSuitableForFieldWork", "ValidUntil")
                        .HasDatabaseName("IX_WeatherData_Tenant_Suitability_Valid")
                        .HasFilter("ValidUntil > GETUTCDATE()");

                    b.HasIndex("TenantId", "ValidUntil", "Timestamp")
                        .HasDatabaseName("IX_WeatherData_Tenant_Validity");

                    b.ToTable("WeatherData", null, t =>
                        {
                            t.HasComment("Weather data for field operation planning and safety assessment");
                        });
                });
            ...
            modelBuilder.Entity("FieldOpsOptimizer.Domain.Entities.WeatherData", b =>
                {
                    b.OwnsOne("FieldOpsOptimizer.Domain.ValueObjects.Coordinate", "Location", b1 =>
                        {
                            b1.Property<Guid>("WeatherDataId")
                                .HasColumnType("uuid");
